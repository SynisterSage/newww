        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <img src="/attached_assets/logo_1754366264944.png" alt="Packanack GC" className="w-6 h-6" />
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-golf-gold rounded-md flex items-center justify-center p-1">
                <img src="/attached_assets/logo_1754366264944.png" alt="Packanack GC" className="w-full h-full object-contain" />
              </div>
              <div>
